...
textos = ["Mario","Alberto","Monica","Sara","Esther","Rafael","Ramon","Jose Luis","Ramon",
 "Maria","Juan","Alberto","Monica","Javier","Javier","Luis","Mario","Lucia","Alberto"]
...
print(list(100 + n for n in numeros if n > 60))
...
paises_letra = [i for i in ["Angola","Portugal","Mejico","India","Luxemburgo","Andorra"] if
"A" not in i.upper()]
print(paises_letra)
numeros_multiplicacion = [i*10 for i in range(1, 6) if i != 4]
print(numeros_multiplicacion)
print(["Mexico" if i == "Mejico" else i for i in ["Angola","Portugal","Mejico","India","Luxemburgo","Andorra"] ])
